    ...
    for num_params in range(1,25):
        ...
        for j in range(length_input):
            ...
            for i in range(num_iterations):
                ...
                cd_smooth = filter_1D.Adaptive_smoothing(signal_pure,cd,mode,noise_estimator)
        ...
        os.chdir('1D')
    # os.chdir('Graphs/'+comp)
    # figsize=(12,9)
    # metrics_1D.Show_data(data_name,figsize,metrics_name_list,path=Graphs/comp)