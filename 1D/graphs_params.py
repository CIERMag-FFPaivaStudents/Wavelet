...
"""
This code is to plot graphs comparing the performance of different parameters set.
"""
...
if __name__ == "__main__":
    ...
    for num_params in range(1,2):
        ...
        for i in range(len(metrics_name)):
            ...
            plt.plot(sigmas,data[k],'green',label='noisy')
            plt.plot(sigmas,data[k+2],'red',label='smooth')
            ...
            plt.savefig(var+' {}_ref.svg'.format(num_params),bbox_inches='tight')
            # plt.close()
        os.chdir('..')
        os.chdir('..')
